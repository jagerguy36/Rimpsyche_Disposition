...
namespace Maux36.RimPsyche.Disposition
{
    ...
    public static class ThoughtUtil
    {
        ...
        public static Dictionary<string, RimpsycheFormula> PosPreceptTagDB = [];
        public static Dictionary<string, RimpsycheFormula> NegPreceptTagDB = [];
        public static Dictionary<string, RimpsycheFormula> PosThoughtTagDB = [];
        public static Dictionary<string, RimpsycheFormula> NegThoughtTagDB = [];
